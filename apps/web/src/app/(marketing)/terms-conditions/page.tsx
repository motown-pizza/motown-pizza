...
export default function TermsConditions() {
  return (
    <div>
      <LayoutSection id="page-terms-conditions-content" padded containerized={'md'}>
        <LayoutIntroSection
          props={{
            subTitle: 'Usage',
        ...
        <Stack mt={SECTION_SPACING} gap={'xl'}>
          ...
          <Stack>
            ...
            <Text>
              Points earned in one size category cannot be combined, merged, exchanged, or
              transferred to another size category.
            </Text>
          </Stack>
          ...
          <Stack>
            ...
            <Text>
              A reward is unlocked when a customer accumulates twelve (12) Slice Points within the
              same size category. Earned rewards are automatically recorded in the customer’s
              loyalty account.
            </Text>
          </Stack>
          ...
          <Stack>
            ...
            <Text>
              Free pizzas must be redeemed in the same size category as the points earned. Rewards
              apply only to standard menu pizzas and are subject to product availability at the time
              of redemption.
            </Text>
          </Stack>
          ...
          <Stack>
            ...
            <Text>
              Loyalty rewards cover the base pizza only. Any premium toppings, stuffed crust
              upgrades, specialty sauces, or additional extras will be charged separately.
            </Text>
          </Stack>
          ...
          <Stack>
            ...
            <Text>
              Slice Points will expire after six (6) months of account inactivity. Expired points
              are forfeited and cannot be reinstated.
            </Text>
          </Stack>
          ...
          <Stack>
            ...
            <Text>
              Rewards have no monetary or cash value and cannot be exchanged, refunded, or redeemed
              for cash or credit.
            </Text>
          </Stack>
          ...
          <Stack>
            ...
            <Text>
              Each customer is permitted to maintain only one (1) loyalty account per mobile phone
              number. Points are non-transferable and may not be sold, gifted, or shared.
            </Text>
          </Stack>
