...
export default function TermsConditions() {
  return (
    <div>
      <LayoutSection id="page-privacy-policy-content" padded containerized={'md'}>
        <LayoutIntroSection
          props={{
            subTitle: 'Privacy',
        ...
        <Stack mt={SECTION_SPACING} gap={'xl'}>
          ...
          <Stack>
            ...
            <Text>
              This is strictly for operational purposes such as order processing, customer service,
              service improvement, and internal business analytics.
            </Text>
          </Stack>
          ...
          <Stack>
            ...
            <Text>
              By joining the Program, customers consent to receive marketing and promotional
          ...
          <Stack>
            ...
            <Text>
              ...
              balance updates, reward notifications, and free pizza alerts.
            </Text>
          </Stack>
