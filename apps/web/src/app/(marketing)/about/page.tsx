...
import ModalFeedback from '@web/ui/common/modal/feedback';
  ...
  return (
    <div>
        ...
        <Grid align="center" gap={'xl'}>
          ...
          <GridCol span={{ base: 12, md: 6 }}>
            ...
            <Stack>
              ...
              <Text>
                ...
                : Quality and Community – We’re more than just a Pizzeria; we’re a gathering for
                friends, families and Pizza enthusiasts alike. Our commitment extends beyond serving
                exceptional pizzas; it’s about nurturing a sense of community. When you order from
                us, you’re not just our customers; you’re our extended family.
              </Text>
          ...
          <GridCol span={12}>
            <Text ta={'center'}>
              ...
              : We believe in continuous improvement, and your feedback is invaluable. Whether it’s
              a suggestion or a compliment, we’re always here to listen. Your input helps us grow
              and serve you better. You can share your feedback{' '}
              <ModalFeedback>
      ...
      <LayoutSection id="page-about-cta" margined containerized={'md'}>
        <Card bg={'var(--mantine-color-pri-6)'} c={'white'} p={{ base: 'md', sm: 'xl' }} my={'xl'}>
          <Stack align="center" gap={'xl'}>
            ...
            <Group justify="center">
              ...
              <AnchorNextLink href="/order/select-store?orderType=collection">
                <Button
                  color="blue"
                  size="md"
                  leftSection={<IconPizza size={ICON_SIZE + 4} stroke={ICON_STROKE_WIDTH} />}
                >
                  View Our Stores
                </Button>
              </AnchorNextLink>
      ...
      <LayoutSection id="page-about-content-1" margined containerized={'sm'}>
        <Stack gap={'xl'}>
          <Stack>
            ...
            <Text>
              Our existence is driven by one purpose: To serve high-quality pizza that is
              delicious,madewith fresh ingredients every day, prepared with care and traceability
              fromresponsible sources.
            </Text>
          </Stack>
          ...
          <Stack>
            ...
            <Text>
              Our people make it happen by ensuring that they do the right thing, the right way. We
              ensure that our staff are treated well, get fair wages, and ensure they share our
      ...
      <LayoutSection id="page-about-content-brand" margined containerized={'md'}>
        ...
        <Stack gap={'xl'}>
          <Stack>
            ...
            <Text>
              ...
              : We believe in using fresh ingredients every day and provide top- notch service.
            ...
            <Text>
              ...
              : We believe in customer satisfaction. We listen to feedback, address concerns
              promptly, and constantly strive to improve.
            </Text>
            ...
            <Text>
              ...
              : As part of our sustainability, we source local and organic ingredients.
            </Text>
          </Stack>
          ...
          <Stack>
            ...
            <Text>
              Our customers are the lifeblood of our business as they provide the revenue, feedback
              and loyalty necessary for the business to thrive and grow. We prioritize customer
              satisfaction and continually striving to meet their needs which builds a strong and
