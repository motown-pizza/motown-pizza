...
import { ProviderInitialize } from '@admin/ui/provider/initialize';
import { ProviderSync } from '@admin/ui/provider/sync';
  ...
  return (
    ...
    >
      <head>
        ...
        <meta name="application-name" content={APP_NAME.ADMIN} />
        ...
        <meta name="apple-mobile-web-app-title" content={APP_NAME.ADMIN} /> */}
