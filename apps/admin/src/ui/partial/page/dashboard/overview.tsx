...
import ChartAreaOverviewMain from '@admin/ui/common/charts/area/overview/main';
import ChartBarOverviewMain from '@admin/ui/common/charts/bar/overview/main';
...
export default function Overview() {
  ...
  return (
    <div>
      <LayoutSection id="overview-header" margined mb={'xl'} containerized={false}>
      ...
      <LayoutSection id="overview-content" margined mt={'xl'} containerized={false}>
        <Grid gap={'lg'}>
          <GridCol span={8}>
                    ...
                    (oi, i) =>
                      i < 2 && (
                        <GridCol key={i} span={12}>
                          <CardOverviewMain props={oi} bg={'var(--mantine-color-dark-8)'} />
                        </GridCol>
                      ),
                  )}
                </Grid>
