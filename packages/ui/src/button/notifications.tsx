...
export function ButtonNotifications({ children }: { children?: React.ReactNode }) {
  const icon = (
...
function NotificationTabs() {
  ...
  return (
    <Tabs defaultValue="all" variant="pills">
      ...
      <TabsPanel value="all">{<Empty props={{ name: 'any notifications' }} />}</TabsPanel>

      <TabsPanel value="messages">{<Empty props={{ name: 'any messages' }} />}</TabsPanel>

      <TabsPanel value="alerts">{<Empty props={{ name: 'any alerts' }} />}</TabsPanel>
    </Tabs>
  );
}
