...
import { IconArrowUp, IconEdit, IconMilk, IconMilkOff, IconTrash } from '@tabler/icons-react';
import { ModalConfirm } from '../modal/confirm';
import { useProductVariantActions } from '@repo/store';
import { Status } from '@repo/types';
import { BadgeStatus } from '../badge/status';

export function CardProductVariant({ props }: { props: ProductVariantGet }) {
  const { productVariantUpdate, productVariantDelete } = useProductVariantActions();
