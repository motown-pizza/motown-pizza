...
import { useFormRecipieItem } from '@repo/hooks';
import {
  Button,
  Card,
  Center,
...
import { IconCheese, IconMeterCube, IconMilk, IconRuler2 } from '@tabler/icons-react';
...
import { MeasurementUnitType, ProductType, Status } from '@repo/types';
import { capitalizeWords } from '@repo/utils';
import Link from 'next/link';

export function FormStoresRecipieItem({
  props,
}: {
  props?: {
  ...
  const ingredient = ingredients?.find((ii) => ii.id == form.values.ingredientId);
              ...
              <Grid>
                <GridCol span={{ base: 12 }}>
                  <Select
                    ...
                    leftSection={<IconCheese size={ICON_SIZE} stroke={ICON_STROKE_WIDTH} />}
                ...
                <GridCol span={{ base: 12 }}>
                  <Select
                    ...
                    leftSection={<IconMilk size={ICON_SIZE} stroke={ICON_STROKE_WIDTH} />}
                    data={groups}
                ...
                <GridCol span={{ base: 12, xs: 6 }}>
                  <NumberInput
                    ...
                    min={0}
                    leftSection={<IconRuler2 size={ICON_SIZE} stroke={ICON_STROKE_WIDTH} />}
                    {...form.getInputProps('quantityNeeded')}
                  />
                </GridCol>
