...
import { useFormStockMovement } from '@repo/hooks';
import {
  Button,
  Card,
  Divider,
...
import { IconCaretUpDown, IconStackPop } from '@tabler/icons-react';
...
export function FormStoresStockMovement({
  props,
}: {
  props?: {
              ...
              <Grid gap={mobile ? 5 : undefined}>
                <GridCol span={{ base: 12, xs: 6 }}>
                  <NumberInput
                    ...
                    min={0}
                    leftSection={<IconStackPop size={ICON_SIZE} stroke={ICON_STROKE_WIDTH} />}
                ...
                <GridCol span={{ base: 12, xs: 6 }}>
                  <Select
                    ...
                    leftSection={<IconCaretUpDown size={ICON_SIZE} stroke={ICON_STROKE_WIDTH} />}
                    data={[
                      {
            ...
            <Group mt={mobile ? 'xs' : undefined}>
              ...
              <Group display={form.isDirty() ? undefined : 'none'}>
                ...
                <Button type="submit" loading={submitted}>
                  {!props?.defaultValues?.updatedAt ? 'Save' : 'Update'}
                </Button>
              </Group>
            </Group>
          </GridCol>
